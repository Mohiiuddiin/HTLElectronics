...
namespace HTLElectronics.Controllers
{
    public class ProductManagerController : Controller
    {
        ...
        public ProductManagerController(IRepository<Product> productContext, IRepository<ProductCategory> productCategoryContext, IRepository<Brand> productCompanyContext) {
        ...
        public ActionResult Index()
        {
            ...
            List<Product> products = context.Collection().Include(x=>x.Category).Include(x=>x.Brand).ToList();
        ...
        public ActionResult Create() {
            ...
            viewModel.Brands = productCompanies.Collection().ToList();
